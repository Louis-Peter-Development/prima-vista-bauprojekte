...
export function FacebookIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M13.5 22v-8.5h2.86l.43-3.32H13.5V8.06c0-.96.27-1.62 1.65-1.62h1.76V3.47c-.85-.09-1.7-.13-2.55-.13-2.53 0-4.26 1.55-4.26 4.38v2.46H7.6v3.32h2.5V22h3.4Z" />
    </svg>
  );
}
...
export function CopyIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" {...props}>
      ...
      <path d="M4 16.5V5.5C4 4.67 4.67 4 5.5 4h11" />
    </svg>
  );
}
...
export function AwardCheckIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" {...props}>
      <circle cx="12" cy="8" r="6" />
      <path d="m9 14-1 8 4-2 4 2-1-8" />
      <path d="m9.5 8 1.6 1.6L15 5.8" />
    </svg>
  );
}
