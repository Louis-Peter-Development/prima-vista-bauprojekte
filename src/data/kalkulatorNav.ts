...
export const KATEGORIEN: KategorieDef[] = [
  ...
  },
  {
    ...
    leaves: [
      ...
      { key: 'fussboden', label: 'Fußbodenheizung', lead: 'Wassergeführt oder elektrisch', Component: lazy(() => import('../components/fussbodenheizung/FussbodenheizungCalculator')) },
      { key: 'waermepumpe', label: 'Luftwärmepumpe', lead: 'Förderfähige Wärmequelle', Component: lazy(() => import('../components/waermepumpe/WaermepumpeCalculator')) },
      { key: 'gas', label: 'Gasheizung', lead: 'Brennwert', Component: lazy(() => import('../components/gas-heizung/GasHeizungCalculator')) },
