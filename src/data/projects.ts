...
export const PROJECTS: Project[] = [
  {
    num: '№ 148', slug: 'bad-soden-einfamilienhaus', title: 'Einfamilienhaus Bad Soden · 2026', ttl: 'Einfamilienhaus Bad Soden', meta: 'Wohnsitz · Bad Soden · 2026', src: '/assets/img/projects/bad-soden-einfamilienhaus-01.webp', size: 'lg', tags: ['wohnsitz'],
    detail: {
      ...
      description: [
        ...
        'Der Ausbau umfasste Dachgeschoss, Trockenbau, Fußbodenheizung mit Estrich, hochwertige Bodenbeläge, Tapezierarbeiten, Malerarbeiten und die Koordination der Ausbaugewerke.',
        'Die Fotostrecke zeigt den Weg von Rohbau- und Fassadenphase über technische Arbeiten bis zu den fertigen Wohn-, Bad- und Schlafräumen.',
      ],
  ...
  {
    num: '№ 147', slug: 'zoi-restaurant', title: 'Zoi — Restaurant · Frankfurt · 2026', ttl: 'Zoi Restaurant', meta: 'Gastronomie · Frankfurt · 2026', src: '/assets/img/projects/zoi-restaurant-01.webp', size: 'lg', tags: ['gastro'],
    detail: {
  ...
  {
    num: '№ 144', slug: 'eiche-parkett', title: 'Eiche Parkett · Wiesbaden · 2025', ttl: 'Eiche Parkett', meta: 'Wohnsitz · Wiesbaden · 2025', src: '/assets/img/projects/eiche-parkett-01.webp', size: 'sm', tags: ['wohnsitz'], revealDelay: 2,
    detail: {
